...
const ProfileTab = () => {
  ...
  return (
    <div className="p-4 space-y-6">
      {/* Profile header */}
      <div className="bg-card rounded-xl p-5 border border-gold/10 text-center">
        <div className="h-16 w-16 rounded-full bg-secondary flex items-center justify-center mx-auto mb-3 border border-gold/20">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <div key={stat.label} className="bg-card rounded-xl p-4 border border-gold/10 text-center">
      ...
      <div className="space-y-2">
        <Button variant="outline" className="w-full justify-start gap-2 border-gold/10 text-foreground hover:bg-secondary" onClick={() => navigate("/admin")}>
